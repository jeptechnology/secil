...
/// @brief A callback function that reads required_count from a stream and writes to the given buffer.
...
/// @brief A callback function that writes count bytes from the given buffer to a stream.
/// @param user_data The user data.
...
/* Struct definitions */
typedef struct { int8_t currentTemperature; } secil_currentTemperature;
typedef struct { int8_t heatingSetpoint; } secil_heatingSetpoint;
typedef struct { int8_t awayHeatingSetpoint; } secil_awayHeatingSetpoint;
typedef struct { int8_t coolingSetpoint; } secil_coolingSetpoint;
typedef struct { int8_t awayCoolingSetpoint; } secil_awayCoolingSetpoint;
typedef struct { int8_t hvacMode; } secil_hvacMode;
typedef struct { bool relativeHumidity; } secil_relativeHumidity;
typedef struct { bool accessoryState; } secil_accessoryState;
typedef struct { char supportPackageData[256]; } secil_supportPackageData;
typedef struct { bool demandResponse; } secil_demandResponse;
typedef struct { bool awayMode; } secil_awayMode;
typedef struct { bool autoWake; } secil_autoWake;
typedef struct { int8_t localUiState; } secil_localUiState;
